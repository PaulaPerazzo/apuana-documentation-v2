...
const TheoryData = () => {
  return (
    <div className="space-y-8">
      <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 border-b pb-4">Processamento de dados</h1>
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200">Paralelismo de modelo</h2>
        <p className="text-gray-700 dark:text-gray-300">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200">Preocupações com a comunicação</h2>
        <p className="text-gray-700 dark:text-gray-300">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200">Preocupações com o sistema de arquivos</h2>
        <p className="text-gray-700 dark:text-gray-300">
