...
const TheoryParts = () => {
  return (
    <div className="space-y-8">
      <h1 className="text-3xl font-bold text-gray-900 border-b pb-4">Partes de um cluster de computação</h1>
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-800">Os nós de login</h2>
        <p className="text-gray-700">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-800">Os nós de computação</h2>
        <p className="text-gray-700">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-800">Os nós de armazenamento</h2>
        <p className="text-gray-700">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-800">Nós diferentes para usos diferentes</h2>
        <p className="text-gray-700">
