...
const TheoryBatch = () => {
  return (
    <div className="space-y-8">
      <h1 className="text-3xl font-bold text-gray-900 border-b pb-4">O gerenciador de carga de trabalho</h1>
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-800">Anatomia de um trabalho</h2>
        <p className="text-gray-700">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-800">Compreendendo a fila</h2>
        <p className="text-gray-700">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-800">Sobre partições</h2>
        <p className="text-gray-700">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-800">Ultrapassando limites</h2>
        <p className="text-gray-700">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-800">Informações sobre Apuana</h2>
        <p className="text-gray-700">
