...
const UserGuidePython = () => {
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200">Pip/Virtualenv</h2>
        <p className="text-gray-700 dark:text-gray-300">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200">Conda</h2>
        <p className="text-gray-700 dark:text-gray-300">
